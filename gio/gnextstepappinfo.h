...
#define G_NEXTSTEP_APP_INFO_CLASS(k)     (G_TYPE_CHECK_CLASS_CAST((k), G_TYPE_NEXTSTEP_APP_INFO, GNextstepAppInfoClass))
...
#define G_NEXTSTEP_APP_INFO_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), G_TYPE_NEXTSTEP_APP_INFO, GNextstepAppInfoClass))
